...
- *"Industrialized Deception: The Collateral Effects of LLM-Generated Misinformation on Digital Ecosystems"* (WWW '26 Companion, [doi:10.1145/3774905.3795471](https://doi.org/10.1145/3774905.3795471)) examines the systemic effects of LLM-generated misinformation on digital platforms, trust networks, and information ecosystems.
- *"Eroding the Truth-Default: A Causal Analysis of Human Susceptibility to Foundation Model Hallucinations and Disinformation in the Wild"* (WWW '26 Companion, [doi:10.1145/3774905.3795832](https://doi.org/10.1145/3774905.3795832)) reports the human perception findings from stimuli generated by this framework.
...
The stimulus corpus is not covered by a single licence, because part of it is not the depositor's to license. The 2,638 machine-generated fragments and all accompanying documentation are released under CC BY 4.0. The 640 human-sourced fragments are excerpts of third-party news material and carry no such grant. Every record states its provenance, so the machine-generated subset can be separated from the rest.
